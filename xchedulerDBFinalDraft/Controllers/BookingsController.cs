...
namespace xchedulerDBFinalDraft.Controllers
{
    public class BookingsController : Controller
    {
        ...
        {
            var bookings = db.Bookings.Include(b => b.AppoinmentDetail);
        ...
        public ActionResult Create([Bind(Include = "RatingId,AppoinmentId,Ratings,Avg_Booking")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RatingId,AppoinmentId,Ratings,Avg_Booking")] Booking booking)
        {
            if (ModelState.IsValid)
            {
